  ...
  return (
    <figure
      ...
      className={`relative select-none overflow-hidden bg-slate-900 ring-1 ${isColumn ? 'ring-slate-900' : ring} ${
        isColumn
          ? 'w-[88vw] rounded-[40px] shadow-[0_-8px_30px_-8px_rgba(13,20,40,0.30),0_22px_50px_-18px_rgba(13,20,40,0.35)]'
          : 'group shrink-0 w-[260px] mx-3 rounded-[28px] shadow-[0_20px_45px_-18px_rgba(13,20,40,0.35)] transition-all duration-500 hover:ring-purple-400/60 hover:-translate-y-2 hover:shadow-[0_30px_60px_-22px_rgba(0,85,164,0.45)]'
      }`}
    >
      ...
      <div className="hidden sm:block relative space-y-16">
        ...
        <div className="space-y-6">
          <RowHeader
            ...
            accent="cyan"
            title={<>Séries <span className="text-gradient-cyan">TV</span></>}
            blurb="Toutes les saisons, ajoutées le jour de leur diffusion, jusqu’en 4K."
          />
        ...
        <div className="space-y-6">
          <RowHeader
            eyebrow="NOUVEAUTÉS CINÉMA"
            icon={<Film className="w-4 h-4" />}
            accent="violet"
            title={<><span className="text-gradient-purple">Films</span> & Cinéma</>}
            blurb="Blockbusters, classiques et nouveautés à la demande, en Dolby 5.1."
          />

...
export const WhatsAppFloatingButton: React.FC = () => {
  ...
  const whatsappUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Bonjour ! Je suis sur le site SwivTV et j’ai besoin d’aide.')}`;
      ...
      {showTooltip && (
        <div className="relative hidden sm:block glass-panel p-3.5 rounded-2xl border border-emerald-500/40 shadow-2xl max-w-xs animate-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="flex items-center gap-2.5 mb-1.5">
            ...
            <span className="text-xs font-bold text-slate-100">Service client IPTV</span>
            <span className="text-[10px] text-emerald-400 font-medium">En ligne</span>
          </div>

          <p className="text-xs text-slate-300 leading-tight">
            Une <strong className="text-emerald-400">commande</strong> ou une question ? On répond en moins d’une minute.
          </p>

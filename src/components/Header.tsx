...
export const Header: React.FC<HeaderProps> = ({ onOpenSpeedTest, onOpenOrder }) => {
  ...
  const whatsappUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Bonjour ! Je souhaite commander un abonnement IPTV SwivTV 4K.')}`;
      ...
      <div className="md:hidden relative">
        ...
        <div
          ...
          className={`absolute inset-0 backdrop-blur-2xl backdrop-saturate-150 transition-all duration-300 ${
            isScrolled
              ? 'bg-white/80 shadow-[0_10px_30px_-16px_rgba(13,20,40,0.45)]'
              : 'bg-white/65'
          }`}
        ></div>
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(60% 130% at 10% 0%, rgba(0,85,164,0.22), transparent 72%),' +
              'radial-gradient(55% 120% at 92% 0%, rgba(239,65,53,0.20), transparent 72%)'
          }}
        />
        ...
        <div className="relative px-3 py-2.5 flex items-center">
          ...
          <a
            ...
            aria-label="Accueil SwivTV"
          >
            <span className="flex items-center justify-center w-8 h-8 rounded-xl bg-gradient-to-br from-purple-600 to-pink-500 shadow-sm">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="ml-auto pl-3.5 pr-2 py-1.5 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white text-[13px] font-extrabold flex items-center gap-0.5 shadow-[0_8px_18px_-8px_rgba(37,99,235,0.9)] active:scale-95 transition-transform"
          >
            <span>Commander</span>
      ...
      <div className="hidden md:block max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2.5 sm:gap-3 group">
            <div className="relative flex items-center justify-center w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br from-purple-600 via-cyan-500 to-pink-500 p-0.5 shadow-lg group-hover:scale-105 transition-transform duration-300 glow-purple">
              <div className="w-full h-full bg-slate-950 rounded-[10px] flex items-center justify-center">
                <Tv className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-400 group-hover:rotate-6 transition-transform duration-300" />
              </div>
            </div>
            <div>
              ...
              <p className="hidden sm:flex text-[10px] text-slate-400 font-medium tracking-wide items-center gap-1">
                ...
                99,9 % de disponibilité Anti-Freeze
              </p>
            </div>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-1 relative rim-live bg-white/70 backdrop-blur-xl backdrop-saturate-150 p-1.5 rounded-full">
            ...
            <a href="#pricing" className="relative px-4 py-2 text-sm font-medium text-purple-600 font-semibold hover:text-purple-700 hover:bg-purple-900 rounded-full transition-all flex items-center gap-1">
              <Sparkles className="w-3.5 h-3.5 text-purple-400" /> Tarifs
            </a>

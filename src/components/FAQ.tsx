      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <h2 className="font-display text-[2.1rem] sm:text-6xl text-slate-100 leading-[0.95]">
            <span className="text-gradient">Questions</span> fréquentes
          </h2>

          <p className="text-slate-400 text-sm sm:text-base max-w-xl mx-auto">
            Installation, qualité de flux et activation.
          </p>
        </div>
        ...
        <div className="mb-8 relative max-w-md mx-auto">
          ...
          <input
            ...
            placeholder="Rechercher (ex. commande, firestick, débit, M3U)..."
        ...
        <div className="mt-12 text-center glass-panel p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-4">
          ...
          <p className="text-xs sm:text-sm text-slate-400">
            Our technical team is online 24 hours a day on WhatsApp to help you set up or answer custom questions.
          </p>
          <a
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I have a question about SwivTV IPTV service.')}`}
            target="_blank"

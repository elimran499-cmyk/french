          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Check if your internet connection is ready for 4K 60fps IPTV
              </p>
            </div>
          </div>
          ...
          {!testing && speed === null && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-300">
                Minimum requirement for 4K Ultra HD: <strong className="text-cyan-400">25 Mbps</strong>
              </p>
              <button
                onClick={startTest}
          ...
          {testing && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400 animate-pulse">
                Testing server response & bandwidth latency...
              </p>
            </div>
          )}
          ...
          {!testing && speed !== null && (
            <div className="space-y-5 animate-in zoom-in-95 duration-200">
              <div className="grid grid-cols-2 gap-4 bg-slate-900/90 p-4 rounded-2xl border border-slate-800">
                <div>
                  <span className="text-[11px] text-slate-400 block font-semibold">Débit descendant :</span>
                  <span className="font-heading font-black text-3xl text-emerald-400">
                    {speed} <span className="text-xs text-slate-400">Mbps</span>
                  </span>
                </div>
                <div>
                  <span className="text-[11px] text-slate-400 block font-semibold">Ping serveur :</span>
              ...
              <div className="p-3.5 rounded-xl bg-emerald-950 border border-emerald-500/40 text-emerald-300 text-xs font-bold flex items-center justify-center gap-2">
                ...
                <span>CONNEXION IDÉALE POUR LE 4K ULTRA HD 60 FPS</span>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-3">
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`Hello! My connection speed is ${speed} Mbps. I want to activate my 4K IPTV subscription now.`)}`}
                  target="_blank"
